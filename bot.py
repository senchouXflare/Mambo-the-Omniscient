...
class SearchClubView(discord.ui.View):
    ...
    async def show_leaderboard(self, interaction: discord.Interaction):
        ...
        try:
            ...
            header_display = f" # {VERT} {'Name':<15} {VERT} Daily {VERT}  Carry  {VERT} Target {VERT} Total"
            separator = f"{HORZ*3}{CROSS}{HORZ*17}{CROSS}{HORZ*7}{CROSS}{HORZ*9}{CROSS}{HORZ*8}{CROSS}{HORZ*6}"
...
async def leaderboard(interaction: discord.Interaction, club_name: str):
    ...
    try:
        ...
        # Format header và separator theo club type
        if is_casual:
            # Casual: Simpler design - # | Name | Daily | Total
            header_display = f" # {VERT} {'Name':<15} {VERT} Daily {VERT} Total"
            separator = f"{HORZ*3}{CROSS}{HORZ*17}{CROSS}{HORZ*7}{CROSS}{HORZ*6}"
        else:
            # Competitive: Original format with Surplus
            header_display = f" # {VERT} {'Name':<15} {VERT} Daily {VERT} Surplus {VERT} Target {VERT} Total"
            separator = f"{HORZ*3}{CROSS}{HORZ*17}{CROSS}{HORZ*7}{CROSS}{HORZ*9}{CROSS}{HORZ*8}{CROSS}{HORZ*6}"
